...
public class RelatedCustomerXactHandler extends XactHandler {
	...
	void process() throws SQLException {
		...
		String sql_get_related_customer = String.format(
			...
			"	from target_orders tos join \n" +
			"			(select ol_w_id, ol_d_id, ol_o_id, ol_i_id from order_line1 \n" +
			...
			this.C_W_ID, this.C_D_ID, this.C_ID, this.C_W_ID, this.C_D_ID, this.C_W_ID);
		if (this.debug) System.out.println(sql_get_related_customer);
